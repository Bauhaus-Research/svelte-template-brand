...
<div transition:fly={{ delay: 100 * i, duration: 300, y: 100, easing: backOut }} id="cards">
	<div class="card">
		<img
			class="bg-cover w-full aspect-auto object-cover card-front-image card-image"
			src={img}
			alt="Img-Fading_component"
		/>
		<div class="card-faders aspect-[9/16]">
			<img class="card-fader card-image aspect-auto" src={img} alt="Img-Fading_component" />
			<img class="card-fader card-image aspect-auto" src={img} alt="Img-Fading_component" />
			<img class="card-fader card-image aspect-auto" src={img} alt="Img-Fading_component" />
			<img class="card-fader card-image aspect-auto" src={img} alt="Img-Fading_component" />
			<img class="card-fader card-image aspect-auto" src={img} alt="Img-Fading_component" />
