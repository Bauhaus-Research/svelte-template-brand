<script>
	export let image =
		'https://images.unsplash.com/photo-1679626951853-60e909d288ac?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80';
</script>
...
<div id="links">
	<div class="meta-link">
		...
		<span class="dot">·</span>
		<a class="source" href="https://advanced.team" target="_blank">
			<i class="fa-solid fa-link" />
		</a>
		<span class="dot">·</span>
		<a class="youtube" href="https://youtu.be/z1wZp4jV4cQ" target="_blank">
